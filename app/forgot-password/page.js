        ...
        <div className="flex h-full flex-col gap-y-8 pt-37.5">
          {step === 0 && (
            <form className="space-y-8">
              <FormHeader size="sm">
                <FormHeader.Title>Forgot your password?</FormHeader.Title>
                <FormHeader.Description>
                  You’ll receive an email shortly with a link to reset your
                  password.
                </FormHeader.Description>
              </FormHeader>
              <Input
          ...
          {step === 1 && (
            <FormHeader size="sm">
              ...
              <FormHeader.Description>
                To reset your password, please enter the 6-digit verification
          ...
          {step === 2 && (
            <form className="space-y-8">
              <FormHeader size="sm">
                <FormHeader.Title>Reset Password</FormHeader.Title>
                <FormHeader.Description>
