      ...
      <div
        ...
        {codes.map((codeValue, idx) => (
          <input
            ...
            className={clsx(
              state === 'error' &&
                'border-semantic-error-300! ring-semantic-error-300 ring-1',
              state === 'success' &&
                'border-semantic-success-300! ring-semantic-success-300 ring-1',

              'text-label-md focus:border-primary-500 flex size-12 items-center justify-center rounded-lg border border-neutral-100 bg-white text-center text-neutral-950 outline-0 disabled:border-neutral-100 disabled:placeholder:text-neutral-100'
            )}
            autoFocus={idx === 0}
