...
export default function NavMobile() {
  ...
  return (
    <>
      ...
      <div className={`z-50 fixed inset-0 md:hidden bg-white p-5 h-screen text-neutral-700 duration-500 ease-out transition-transform ${isNavOpen ? "-translate-y-full" : "translate-y-0"}`}>
