...
const SvgIconFileCode = (props) => (
  ...
  >
    <path
      fill="#000"
      d="M9.857 13.264a.75.75 0 0 1 .674.206.75.75 0 0 1 0 1.06L9.06 16l1.47 1.47A.75.75 0 0 1 9.47 18.53l-2-2a.75.75 0 0 1 0-1.061l2-2a.75.75 0 0 1 .387-.206M12.857 13.263a.76.76 0 0 1 .674.206l2 2a.75.75 0 0 1 0 1.062l-2 2a.75.75 0 0 1-1.061 0 .75.75 0 0 1 0-1.061L13.94 16l-1.47-1.47a.75.75 0 0 1 .387-1.267"
    />
    <path
      fill="#000"
      fillRule="evenodd"
