...
const SvgIconInfoSquare = (props) => (
  ...
  >
    <path
      fill="#000"
      d="M12 11.179a.75.75 0 0 1 .75.75V16.5a.75.75 0 0 1-1.5 0v-4.571a.75.75 0 0 1 .75-.75M12.02 7.5l.102.005a1 1 0 0 1-.204 1.99 1.005 1.005 0 0 1-.903-.995c0-.552.443-1 .995-1z"
    />
    <path
      fill="#000"
      fillRule="evenodd"
...
export default SvgIconInfoSquare;
