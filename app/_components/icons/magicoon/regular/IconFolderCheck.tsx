...
const SvgIconFolderCheck = (props) => (
  <svg
  ...
  >
    <path
      fill="#000"
      d="M13.969 11.303a.751.751 0 0 1 1.061 1.061l-3.333 3.333a.753.753 0 0 1-1.062.001l-1.667-1.667a.75.75 0 0 1 1.061-1.061l1.137 1.136z"
    />
    <path
      fill="#000"
      fillRule="evenodd"
...
export default SvgIconFolderCheck;
