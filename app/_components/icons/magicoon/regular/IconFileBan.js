...
const SvgIconFileBan = (props) => (
  ...
  >
    <path
      fill="currentColor"
      fillRule="evenodd"
      d="M12.5 10.25a4.254 4.254 0 0 1 4.25 4.25 4.254 4.254 0 0 1-4.25 4.25 4.254 4.254 0 0 1-4.25-4.25 4.254 4.254 0 0 1 4.25-4.25m-1.331 6.642c.396.22.846.358 1.331.358a2.75 2.75 0 0 0 2.75-2.75c0-.424-.105-.822-.28-1.18a3 3 0 0 0-.077-.151zM12.5 11.75a2.75 2.75 0 0 0-2.75 2.75 2.7 2.7 0 0 0 .358 1.331l3.723-3.723a2.7 2.7 0 0 0-1.331-.358"
      clipRule="evenodd"
    />
    <path
      fill="currentColor"
